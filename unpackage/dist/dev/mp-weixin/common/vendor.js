...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"graduation-demo1","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!**********************************************************!*\
  !*** D:/Graduation Project/AppoinmentProject/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!*****************************************************************!*\
  !*** D:/Graduation Project/AppoinmentProject/common/api/api.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = cloud;function cloud(option) {
  return new Promise(function (resolve, reject) {
    uni.showLoading({
      title: '拼命加载中',
      mask: true });var
    ...
    option.name,_option$data = option.data,data = _option$data === void 0 ? {} : _option$data;
...
/* 17 */
/*!**************************************************************************!*\
  !*** D:/Graduation Project/AppoinmentProject/pages.json?{"type":"stat"} ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__5CDF9EF" };exports.default = _default;
...
/* 24 */
/*!****************************************************************!*\
  !*** D:/Graduation Project/AppoinmentProject/utils/storage.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getWxLoginUserInfo = getWxLoginUserInfo;exports.setWxLoginUserInfo = setWxLoginUserInfo;exports.getLoginUserInfo = getLoginUserInfo;exports.setLoginUserInfo = setLoginUserInfo;exports.getOpenId = getOpenId;exports.setOpenId = setOpenId; // import store from '../store/index.js';
function getWxLoginUserInfo() {
  var userInfo = uni.getStorageSync('loginWxUserInfo');
...
function setWxLoginUserInfo(userInfo) {
  var data = userInfo || {};
  try {
...
function getLoginUserInfo() {
  var userInfo = uni.getStorageSync('loginUserInfo');
  if (userInfo != '' && JSON.stringify(userInfo) != '{}') {
    return JSON.parse(userInfo);
  }
  return {};
...
function getOpenId() {
  var userInfo = uni.getStorageSync('openId');
  if (userInfo != '' && JSON.stringify(userInfo) != '{}') {
    return JSON.parse(userInfo);
  }
  return {};
...
/* 33 */
/*!**************************************************************!*\
  !*** D:/Graduation Project/AppoinmentProject/utils/scert.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function encodeUTF8(s) {
  ...
  for (i = 0; i < s.length; i++) {
    if ((c = s.charCodeAt(i)) < 0x80) r.push(c);else
    if (c < 0x800) r.push(0xC0 + (c >> 6 & 0x1F), 0x80 + (c & 0x3F));else
    {
      if ((x = c ^ 0xD800) >> 10 == 0) //对四字节UTF-16转换为Unicode
        c = (x << 10) + (s.charCodeAt(++i) ^ 0xDC00) + 0x10000,
        r.push(0xF0 + (c >> 18 & 0x7), 0x80 + (c >> 12 & 0x3F));else
...
function sha1(s) {
  ...
  function () {return m[1] ^ m[2] ^ m[3];}],
  rol = function rol(n, c) {return n << c | n >>> 32 - c;},
